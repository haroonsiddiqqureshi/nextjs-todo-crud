  ...
  return (
    <div className="min-h-screen p-6">
      ...
      <div className="flex justify-center items-center">
        <div className=" px-10 bg-white w-[500px] rounded-lg shadow-lg">
          <form onSubmit={handleSubmit} className="mt-6">
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                disabled={loading}
                className={`mb-10 bg-pastel-blue hover:bg-pastel-blue-dark px-4 py-2 rounded-md transition font-bold text-blue-500 hover:text-blue-600 flex shadow-lg justify-center items-center gap-2 ${loading ? "opacity-75" : ""}`}
              >
                {loading ? (
                  <svg
                    aria-hidden="true"
